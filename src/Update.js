...
import { updateVoca } from "../../vocabulary/src/redux/modules/voca";
...
const Update = (props) => {
    ...
    const page_index = useParams().index;
    ...
    const onClick = (e) => {
        ...
        const voca_id = voca_list[page_index].id
    ...
    return (
        ...
        <Container>
            ...
            <AddButton onClick = {onClick}>수정하기</AddButton>
